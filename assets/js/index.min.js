window.$docsify.plugins = [].concat((e, t) => {
    ...
    var i = (e) => {
        if (
            ...
            document.documentElement.setAttribute('data-doc-theme', 'light');
        }
        else if ("dark" == e) {
            for (var [t, r] of Object.entries(o.dark)) document.documentElement.style.setProperty("--" + t, r);
            document.documentElement.setAttribute('data-doc-theme', 'dark');
        }
    };
